...
def custom():
    ...
    width_text=Label(custom_window,text='width:(4~36)',font='300',bg='#68daff')                  #寬度文字
...
def set_button():
    ...
    window.geometry(f'{frame1.winfo_width()+20}x{frame1.winfo_height()+110}+{700-20*(game_X_size-4)}+80') #配置位置
set_button()
new_play_game()
window.mainloop()