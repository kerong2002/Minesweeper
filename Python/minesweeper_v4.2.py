...
def new_play_game():
    ...
    frame1.update()
    frame2 = Frame(bg="#d0d0d0", bd=2, relief=SUNKEN, width=frame1.winfo_width()-10, height=60)
    ...
    time_text.place(relx=0.96,rely=0.5,anchor=CENTER)
